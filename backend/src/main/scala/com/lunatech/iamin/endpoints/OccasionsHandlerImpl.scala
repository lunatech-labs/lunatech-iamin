...
class OccasionsHandlerImpl[F[_] : Async](service: OccasionService[F], obs: IdObfuscator) extends OccasionsHandler[F] {
  ...
  override def postOccasions(respond: PostOccasionsResponse.type)(obfuscatedUserId: String, body: PostOccasionRequestJson): F[PostOccasionsResponse] = {
  ...
  override def getOccasionByDate(respond: GetOccasionByDateResponse.type)(obfuscatedUserId: String, date: String): F[GetOccasionByDateResponse] = {
    val userId = obs deobfuscate obfuscatedUserId
  ...
  override def patchOccasionByDate(respond: PatchOccasionByDateResponse.type)(obfuscatedUserId: String, date: String, body: PatchOccasionRequestJson): F[PatchOccasionByDateResponse] = {
    val userId = obs deobfuscate obfuscatedUserId
    val ldt = LocalDate.parse(date) // TODO: Purify
  ...
  override def deleteOccasionByDate(respond: DeleteOccasionByDateResponse.type)(obfuscatedUserId: String, date: String): F[DeleteOccasionByDateResponse] = {
    val userId = obs deobfuscate obfuscatedUserId
    val ldt = LocalDate.parse(date) // TODO: Purify
